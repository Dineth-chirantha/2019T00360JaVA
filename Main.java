...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String myName = "Dineth" + "  "+"Chirantha";
        ...
        if (age < 18){
            ...
            System.out.println("Too old to drive. Please submit a helth check result");
        }
        else {
        ...
        if (apiVersion <= DEPRECATED_VERSION){
            ...
            System.out.println("Accepetd API Version:" + apiVersion);
        }
        */
